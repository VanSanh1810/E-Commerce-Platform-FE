    ...
    return (
        <>
            <footer className="main">
                <section style={{ borderTop: '5vw solid #188078' }} className="section-padding footer-mid">
                                    ...
                                    <div className="col-md-8 col-lg-12">
                                        ...
                                        <div className="download-app wow fadeIn animated">
                                            <a href="#" className="hover-up mb-sm-4 mb-lg-0">
                                                <img className="active" src="/assets/imgs/theme/app-store.jpg" alt="" />
                                            </a>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <p className="float-md-left font-sm text-muted mb-0">
                                &copy; {new Date().getFullYear()},<strong className="text-brand"> Evara</strong> - React Redux
