...
const Login = ({ user, userLogin, userLogout }) => {
    ...
    //forgot password refields
    const f_mailRef = useRef();
    ...
    const resetPassHandler = async (e) => {
        e.preventDefault();
        if (!f_mailRef.current.value) {
            toast.error('Please provide your account email !');
        } else {
            try {
                const result = await axiosInstance.post('/api/auth/resetPass', {
                    email: f_mailRef.current.value,
                });
                toast.success('An email has been send to your mailbox');
            } catch (err) {
                console.log(err);
                toast.error();
            }
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div
                                                ...
                                                style={{ marginLeft: '23vw', marginRight: '23vw' }}
                                            >
                                                <div className="padding_eight_all bg-white">
                                                    ...
                                                    <form method="post" onSubmit={resetPassHandler}>
