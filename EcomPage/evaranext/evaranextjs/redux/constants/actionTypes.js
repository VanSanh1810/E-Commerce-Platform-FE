// PRODUCT TAG HISTORY
export const ADD_TAG_HISTORY = 'ADD_TAG_HISTORY';
export const INIT_TAG_HISTORY = 'INIT_TAG_HISTORY';
export const CLEAR_TAG_HISTORY = 'CLEAR_TAG_HISTORY';
// CONVERSATION TYPE
export const SELECTED_CONVERSATION = 'SELECTED_CONVERSATION';
// CART SELECTED TYPE

export const SET_CART_SELECTED = 'SET_CART_SELECTED';
export const CLEAR_CART_SELECTED = 'CLEAR_CART_SELECTED';
...
export const DELETE_MULTIPLE_FROM_CART = 'DELETE_MULTIPLE_FROM_CART';
